...
class UnifiedTab extends StatelessWidget {
            ...
            ResponsiveListView(
              ...
              children: [
                ...
                if (sendVm.selectedFiles.isEmpty) ...[
                  ...
                  // Grid-like Selection: 2 rows of 3 columns, original sized buttons
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: _horizontalPadding),
  ...
  Widget _buildSelectionGrid(BuildContext context, Ref ref) {
    ...
    final isDesktop = SizingInformation(MediaQuery.sizeOf(context).width).isDesktop;
    final itemWidth = isDesktop ? BigButton.desktopWidth : BigButton.mobileWidth;
        ...
        return Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              ...List.generate(3 - chunk.length, (_) => SizedBox(width: itemWidth)),
            ],
          ),
        );
      }).toList(),
